    ...
    <form action={action} className="space-y-6">
      ...
      <div className="grid grid-cols-1 gap-6 sm:grid-cols-6">
        ...
        <div className="sm:col-span-4">
          <label className="block text-sm font-medium text-gray-700">ชื่อ-นามสกุล (ภาษาไทย)</label>
          <input
            type="text"
            name="full_name"
          ...
          />
          {state?.errors?.full_name && <p className="text-xs text-red-600 mt-1">{state.errors.full_name}</p>}
        </div>
        ...
        <div className="sm:col-span-2">
          ...
          <input
            ...
            className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm border px-3 py-2"
          />
          {state?.errors?.nickname && <p className="text-xs text-red-600 mt-1">{state.errors.nickname}</p>}
        </div>
        ...
        <div className="sm:col-span-4">
          ...
          <input
            ...
            className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm border px-3 py-2"
          />
          {state?.errors?.student_id && <p className="text-xs text-red-600 mt-1">{state.errors.student_id}</p>}
        </div>
        ...
        <div className="sm:col-span-3">
          ...
          <input
            ...
            className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm border px-3 py-2"
          />
          {state?.errors?.phone_number && <p className="text-xs text-red-600 mt-1">{state.errors.phone_number}</p>}
        </div>

        {/* 6. ปีการศึกษาที่เข้า (Admission Year) */}
        <div className="sm:col-span-3">
          <label className="block text-sm font-medium text-gray-700">ปีการศึกษาที่เข้า (พ.ศ.)</label>
          <input
            type="number"
            name="admission_year"
            ...
            className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm border px-3 py-2"
          />
          {state?.errors?.admission_year && <p className="text-xs text-red-600 mt-1">{state.errors.admission_year}</p>}
        </div>
        ...
        <div className="sm:col-span-3">
          ...
          {state?.errors?.faculty && <p className="text-xs text-red-600 mt-1">{state.errors.faculty}</p>}
        </div>
        ...
        <div className="sm:col-span-3">
          ...
          <input
            ...
            className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm border px-3 py-2"
          />
          {state?.errors?.major && <p className="text-xs text-red-600 mt-1">{state.errors.major}</p>}
        </div>
      ...
      <div className="flex justify-end gap-3 pt-4 border-t border-gray-100">
        ...
        <button
          ...
          className={`rounded-md px-4 py-2 text-sm font-semibold text-white shadow-sm focus-visible:outline focus-visible:outline-offset-2 focus-visible:outline-indigo-600 
            ${isPending ? 'bg-indigo-400 cursor-not-allowed' : 'bg-nature hover:bg-nature-dark'}`}
        >
